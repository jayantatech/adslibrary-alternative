...
const FeatureFourSection = () => {
  return (
    <div className="w-full h-auto bg-bladck py-14">
      <ContentWrapper>
        <div className="flex flex-row-reverse max-lg:flex-col-reverse gap-4 max-md:gap-14 min-h-[640px] bg-cyand-300 py-4">
          <div className="w-1/2 h-full bg-slated-400 lg:pr-10 max-lg:w-full lg:pt-10">
            <span className="text-[20px] font-semibold font-OpenSans text-black">
              simple steps to install
            </span>
            <h2 className="lg:text-[48px] text-[36px] max-md:text-[26px]  max-lg:text-[34px]  font-OpenSans font-semibold text-black">
              Install our extension to save ads effortlessly
            </h2>
            <p className="text-[16px] font-OpenSans py-1 text-black">
            ...
            <div className="w-full h-auto mt-4 flex flex-col gap-3 ">
              <div className=" w-full h-[110px] hover:scale-[.98] transition-all duration-150 bg-lightBlue shadow-md px-2 py-3 rounded-md flex gap-2">
                <div className="w-[28px] h-full bg-cydan-200 text-[20px]">
                  <div className="w-full h-[28px] bg-mainBlue text-white flex items-center justify-center rounded-md">
                    1
                  </div>
                </div>
                <div className="w-full h-full bg-emeradld-200">
                  <p className="text-[16px] text-black font-OpenSans ">
                    Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                    Autem vero itaque dolores officiis quia ad deleniti placeat
                    impedit iusto praesentium.officiis quia ad deleniti placeat
                    impedit iusto praesentium.
                  </p>
                </div>
              </div>
              <div className=" w-full h-[110px] hover:scale-[.98] transition-all duration-150 bg-lightBlue shadow-md px-2 py-3 rounded-md flex gap-2">
