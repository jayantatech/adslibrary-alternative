...
const PanelHeader = () => {
  ...
  return (
    <header className="w-full min-h-[68px] h-auto shadow bg-lightBlue border-slate-200  flex items-center justify-start flex-row lg:px-4 text-lg z-50 sticky top-0 left-0 py-2 max-lg:justify-between ">
      <div className=" w-full h-auto flex items-center justify-between px-2 lg:hidden ">
      ...
      <div className=" min-w-[33%] bg-redd-300 w-auto h-full flex items-center justify-start max-lg:hidden">
      ...
      <div className="w-auto min-w-[33%] flex items-center justify-center h-full px-4 max-lg:hidden">
        <SearchComponent />
      </div>
      <div className="min-w-[33%] h-full flex items-center justify-end bg-sldate-500 bg-dred-500 max-lg:hidden">
        <UserCard />
      </div>
      <div
        className={`w-full max-lg:h-full max-md:h-full h-auto bg-lightBlue fixed top-[76px] py-2 lg:hidden transition-all duration-200 z-50 px-2 ${
          menuOpen ? "-translate-y-3" : "-translate-y-[140%]"
        }`}
      >
        <div className="w-full max-md:h-auto h-auto">
          <div className="lg:w-[220px] max-lg:w-full max-md:h-[64px] px-2 py-2 h-[50px] border-2 border-slate-200 rounded-md bg-white flex gap-2 items-center justify-start">
          ...
          <div className="w-full max-lg:h-[68px] max-md:h-[110px] flex flex-row gap-6 max-md:gap-3 items-center justify-center max-md:flex-col max-md:w-full">
            <div className="w-full max-md:w-full h-auto bgd-red-500 flex items-center justify-center gap-2">
              <button className="max-lg:w-full h-[40px] bg-mainBlue text-white rounded-[4px] text-[15px] font-semibold font-OpenSans hover:scale-[.98] transition-all duration-200 hover:bg-blue-500 shadow flex items-center justify-center gap-2">
