  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-blue-500 text-white hover:bg-blue-600 focus:bg-blue-600 dark:bg-blue-300 dark:text-slate-900 dark:hover:bg-blue-400 dark:focus:bg-blue-400", // Updated color
        day_today:
