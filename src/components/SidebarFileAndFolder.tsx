...
// import { cn } from "@/lib/utils"; // Import utility for conditional classes if needed
// import { Folder } from "lucide-react";
// import { AiFillFolderOpen } from "react-icons/ai";
// import { BsFileEarmarkCheck, BsFileEarmarkPlay } from "react-icons/bs";
...
// function SidebarFileAndFolder({
//   folderName,
//   fileArray,
// }: SidebarFileAndFolderProps) {
//   return (
...
//         <div className="bg-red-d400 flex flex-col">
//           {fileArray.map((file) => (
//             <AccordionContent className="no-animation flex bg-slate-500 flex-col gap-1 pb-1.5 pl-5 bg-bdlue-300">
...
//                 </div>
//                 <div className="w-auto h-auto flex items-center justify-center px-1 hover:border border border-transparent hover:border-blue-500 bg-greden-300 cursor-pointer rounded">
